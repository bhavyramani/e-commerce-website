        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5" style={{ "textAlign": "left" }}>
                <div className='lg:col-span-3'>
                    <form className='bg-white px-5 py-12 mt-12 pb-10'>
                ...
                <div className='lg:col-span-2'>
                    <div className=" bg-white mt-12 mx-auto max-w-7xl px-0 sm:px-0 lg:px-0">
                                        ...
                                        <li key={product.id} className="flex py-6">
                                            ...
                                            <div className="ml-4 flex flex-1 flex-col">
                                                <div>
                                                    ...
                                                    <p className="mt-1 text-sm text-gray-500" style={{ "textAlign": "left" }}>{product.color}</p>
                                                </div>
